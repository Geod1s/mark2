...
// //     const vendorGroups = orderData.items.reduce((groups, item) => {
// //       if (!groups[item.vendor_id]) {
// //         groups[item.vendor_id] = []
// //       }
// //       groups[item.vendor_id].push(item)
// //       return groups
// //     }, {} as Record<string, CashOrderItem[]>)
...
// //       success: true, 
// //       orderIds,
// //       message: "Cash order placed successfully! The vendor will contact you for payment and delivery."
// //     }
